...
- **BlueRetro** — DIY-адаптер на ESP32 эмулирует оба джойстик-порта по Bluetooth HID (PS/4/5, Xbox, Wii/Switch и др.), протокол CLOCK/LATCH/DATA идентичен физическому Dendy-джойстику. Требует подключённого внешнего PSU. Сборка адаптера на 3.3V-логике: https://github.com/alex-snigir/BlueRetro-3.3V-logic
